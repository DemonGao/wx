...
<body class="sticky-header">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="menu-list nav-active"><a href="#"><i
						...
						<ul class="sub-menu-list nav-active">
							<li ><a href="<%=basePath%>admin/pages/news.jsp">动态</a></li>
										...
										<table class="table table-striped table-hover table-bordered table-condensed" id="editable-sample">
											<thead>
												<tr>
													...
													<th style="text-align:center">案例标题</th>
											...
											<tbody class="tbodylist">							
												 <tr v-for="item in list " v-on:dblclick="trdbclick($event)">
												 	<td>
												 		<input type="checkbox" :value="item.case_id" />
												 	</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">案例添加</h4>
				</div>
				<div class="modal-body">
					<form action="<%=basePath %>Admin/addCases"  class="form-horizontal" role="form" id="addModelForm" enctype="multipart/form-data" method="post">
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label" for="add_case_name">案例名称</label>
							<div class="col-sm-10 col-xs-12">
								<input type="text" class="form-control" id="add_case_name"
									name="cases.case_name" placeholder="请输入案例名称" required="required">
							</div>
						</div>
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label" for="add_case_type">案例分类</label>
							<div class="col-sm-10 col-xs-12">
								<select class="form-control" id="add_case_type" name="cases.case_type">
									<option>水务</option>
									<option>电商</option>
								</select>
							</div>
						...
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label" for="add_case_img">上传图片</label>
							<div class="col-sm-10 col-xs-12">
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<%=basePath %>Admin/upCases"  class="form-horizontal" role="form" id="upModelForm" enctype="multipart/form-data" method="post">
						<input type="hidden" name="cases.case_id" id="up_case_id"/>
						<input type="hidden" name="cases.case_date" id="up_case_date" />
						<input type="hidden" name="cases.case_img" id="up_case_img" />
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label" for="up_case_name">标题</label>
							<div class="col-sm-10 col-xs-12">
								<input type="text" class="form-control" id="up_case_name"
									name="cases.case_name" v-model="" placeholder="请输入文章标题">
							</div>
						</div>
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label" for="add_case_type">案例分类</label>
							<div class="col-sm-10 col-xs-12">
								<select class="form-control" id="up_case_type" name="cases.case_type">
						...
						<div class="form-group form-group-lg">
							<label class="col-sm-2 col-xs-12 control-label">上传图片</label>
							<div class="col-sm-10 col-xs-12">
								<div class="fileupload fileupload-new"
									data-provides="fileupload">
									<input type="hidden" value="" name="">
						...
						<div class="form-group form-group-lg">
							...
							<div class="col-sm-10 col-xs-12">
								<textarea class="form-control" placeholder="请输入关于动态的介绍" required="required" name="cases.case_text" id="update_case_text" rows="4"></textarea>  
							</div>
						</div>
						<!-- 
						<div class="wrapper nopadding">
	...
	<script type="text/javascript" src="<%=basePath%>admin/statics/js/cases.js"></script>
