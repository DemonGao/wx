		...
		<div class="weui_tab" id="bxbsj">
			...
			<div class="weui_tabbar">
				<a href="javascript:;" class="weui_tabbar_item margin-l-15 margin-r-15 bg-error">
					<p class="weui_tabbar_label" v-on:click="jobPost_yes()"><i class="iconfont icon-toudi"></i>标记为感兴趣</p>
				</a>
				<a href="javascript:;" class="weui_tabbar_item margin-l-15 margin-r-15 bg-success" >
					<p class="weui_tabbar_label" v-on:click="jobPost_no()"><i class="iconfont icon-ganxingqu"></i>拒绝</p>
				</a>
			</div>
		</div>
