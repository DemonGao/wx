...
">
	...
	<body ontouchstart>
		<div class="weui_panel weui_panel_access" style="margin-top: 0;" id="bxbsj">
			<div v-for="item in data" class="weui_panel weui_panel_access nomargin noborder-t">
				<div class="weui_panel_bd border-t-default">
					<a :href="getResumeHref(item.student.open_id,item.jobPost_id)" class="weui_media_box weui_media_appmsg padding10">
						<div class="weui_media_hd">
							<img v-if="hasImg(item.student.student_img)" style="width: 100%;height: 100%;" class="weui_media_appmsg_thumb" :src="baseUrl + item.student.student_img.slice(1,-1).split(',')[0]" alt="">
							<img v-else="hasImg(item.student.student_img)" style="width: 100%;height: 100%;" class="weui_media_appmsg_thumb" src="data:image/png;base64," alt="">
						</div>
						<div class="weui_media_bd padding">
							<h4 class="weui_media_title"><span class="font-14 color-blue">{{item.student.student_name}}<i class="iconfont margin-l-15" v-bind:class="{ 'icon-nv': item.student.student_gender==='女','color-deepred': item.student.student_gender==='女', 'icon-shouyezhuyetubiao06': item.student.student_gender==='男','color-blue': item.student.student_gender==='男' }" ></i></span> <span class="float_r font-14" style="vertical-align: super;">{{item.job.job_time | date}}</span></h4>
							<p class="weui_media_desc">
								<span class="font-12 color-default" style="vertical-align: -webkit-baseline-middle;">{{item.job.job_name}}</span>
	...
	<script type="text/javascript">
		...
		var bxbsj = new Vue({
			...
			methods : {
				...
				getResumeHref : function(val1,val2) {
					return '/wxkf/bxbsj/cpage/jobfeedback_cresume.jsp?student_id=' + val1+'&jobPost_id='+val2;
				},
