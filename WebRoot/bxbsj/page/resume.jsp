		...
		<div class="weui_tab" id="bxbsj">
			<div class="weui_tab_bd">
				<div class="box nospacebox nopadding nomargin">
					<div class="weui-row weui-no-gutter box plate nomargin">
						...
						<div class="weui-col-75 padding10">
							<p>
								<b class="font-16" v-cloak>{{data.student_name}}</b>
							...
							<p>
								<span class="margin-r-15" v-cloak>{{data.student_school}}</span>
								<span v-cloak>{{data.student_major}}</span>
							</p>
							<p class="font-12 margin-t-5">
								<span v-cloak>{{data.student_residence}}</span> | <span v-cloak>{{data.student_qualifications}}</span>
								<p class="color-default06 font-12 margin-t-5" v-cloak>{{data.student_state}}</p>
							</p>
						</div>
				...
				<div v-if="data.student_mailbox==null||data.student_tel==null||data.student_qq==null" class="box padding10">
					...
					<p v-if="data.student_mailbox!=null&&data.student_mailbox!=''" v-cloak><i class="iconfont icon-youxiang margin-r-5 font-22"></i>{{data.student_mailbox}}</p>
					<p v-if="data.student_tel!=null&&data.student_tel!=''" v-cloak><i class="iconfont icon-shouji margin-r-5 font-22"></i>{{data.student_tel}}</p>
					<p v-if="data.student_qq!=null&&data.student_qq!=''" v-cloak><i class="iconfont icon-qq margin-r-5 font-22"></i>{{data.student_qq}}</p>
					...
					<div class="font-14 color-default04">
						...
						<div v-else="data.studentExperience.length==0">
							<div v-for="(stuExp,index) in data.studentExperience">
								<span class="color-default06 margin-r-10" v-cloak>{{stuExp.studentexp_entrytime}} — {{stuExp.studentexp_departuretime}}</span>
								<span class="color-default" v-cloak>{{stuExp.studentexp_company}}</span>
								<span class="color-default" v-cloak>{{stuExp.studentexp_jobname}}({{stuExp.studentexp_jobtype}})</span>
								<p style="margin-left: 66px;" v-cloak>{{stuExp.studentexp_describe}}</p>
				...
				<div class="box padding10" id="assess">
					...
					<div class="font-14 color-default04" >
						...
						<div v-else="data.student_aboutme==null||data.student_aboutme==''" v-cloak>
				...
				<div class="box padding10">
					...
					<div class="font-14 color-default04">
						...
						<div v-else="data.student_speciality==null||data.student_speciality==''" v-cloak>
