	...
	<body ontouchstart>
		...
		<div class="weui_tab">
			...
			<div class="weui_tabbar">
				<a href="<%=basePath %>bxbsj/company_index.jsp" class="weui_tabbar_item weui_bar_item_on">
					<div class="weui_tabbar_icon" style="text-align:center">
						<i class="iconfont icon-shouye-shouye" style="font-size:22px;"></i>
					</div>
					<p class="weui_tabbar_label">首页</p>
				</a>
				<a href="<%=basePath %>bxbsj/cpage/cmessage.jsp" class="weui_tabbar_item">
					<div class="weui_tabbar_icon" style="text-align:center">
						<i class="iconfont icon-xiaoxi" style="font-size:22px;"></i>
					</div>
					<p class="weui_tabbar_label">消息</p>
				</a>
				<a href="<%=basePath %>bxbsj/cpage/cme.jsp" class="weui_tabbar_item">
					<div class="weui_tabbar_icon" style="text-align:center">
