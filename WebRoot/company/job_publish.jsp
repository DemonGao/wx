        ...
        <div class="box margin-t-10 ">
            ...
            <div class=" bg_white of-hidden margin-t-15 padding20">
                ...
                <form action="#" method="post" id="companyinfoForm">
                	...
                	<input type="hidden" name="job.job_id" v-model="job.list.job_id" />
                    ...
                    <div class="listform">
                            <div class="form-group">
                                ...
                                <input type="text" id="job_name" class="inputtext" name="job.job_name" v-model="job.list.job_name" />
                            </div>
                            <div class="form-group">
                                <label for="companyinfo_address">工作类型</label>
                            	<select class="inputtext" name="job.job_style" value="job.list.job_style">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="job_name" class="inputtext number" name="job.job_recivenum" v-model="job.list.job_recivenum" placeholder="职位招聘人数"/>
                                <span>人</span>
                            ...
                            <div class="form-group">
                            	...
                            	<select class="inputtext" name="job.job_education" value="job.list.job_education">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="job_limittime" class="inputtext number" name="job.job_limittime" v-model="job.list.job_limittime" placeholder="职位招聘时长"/>
                                <span>天</span>
                                <!--<textarea name="companyinfo.companyinfo_about" id="companyinfo_about" class="inputtextarea" cols="30" rows="5"></textarea>
                              -->
                            </div>
                    ...
                    <div class="listform">
                        <div class="form-group">
                            ...
                            <input type="number" id="job_salary" class="inputtext number" name="job.job_salary" v-model="job.list.job_salary" />
                           	<span>元</span>  
                        </div>
                        <div class="form-group">
                        	<label for="job_label">福利标签</label>
                            <input type="text" id="job_label" class="inputtext" name="job.job_label" v-model="job.list.job_label" placeholder="每个标签请以小写逗号(,)分割" /> 
                        </div>
                    </div>
                    <div class="box-defalut-tip padding10 margin-t-15" >
                    ...
                    <div class="listform">
                    	<div class="form-group">
                            ...
                            <select class="inputtext" name="job.job_type" v-model="job.list.job_type">
                        ...
                        <div class="form-group">
                        	...
                        	<textarea name="job.job_require" id="job_require" v-model="job.list.job_require" class="inputtextarea" cols="30" rows="5" placeholder="请输入岗位工作内容、职位要求、工作时间等..."></textarea>
...
bxbsj.job = AjaxTeam.getJob(<%=request.getParameter("job_id")%>);
