...
<body ontouchstart>
	...
	<div class="container" id="container">
		<div class="tabbox active" id="tabbox1">
			...
			<div class="weui_cells weui_cells_form">
				...
				<%
						...
						OAccessToken otoken = WeixinUtil.getOAccessToken(request
				...
				<div class="weui_cell weui_cell_select">
					...
					<div class="weui_cell_bd weui_cell_primary email">
						<select id="emailselect" class="weui_select email_select"
							name="select1">
		...
		<div class="tabbox tabbox2">
			...
			<div class="btndiv">
				<a id="step2"
					href="https://www.amazon.cn/ap/signin?openid.return_to=https%3A%2F%2Fwww.amazon.cn%2Fmn%2Fdcw%2Fmyx.html&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=cnamazon&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&accountStatusPolicy=P1#/home/settings/payment"
					class="weui_btn weui_btn_primary">知道怎么添加信任,直接前往亚马逊</a>
			</div>
			<!-- 
		...
		<div class="tabbox">
			...
			<div class="btndiv">
				<button href="javascript:;" id="step3"
					class="weui_btn weui_btn_primary">添加完成，发送测试邮箱到kindle设备</button>
			</div>
		</div>
	</div>
</body>
...
<script type="text/javascript">
	...
	$("#tabul li").on(
			...
			function() {
				...
				$(this).siblings().removeClass("active").find("span")
						.removeClass("active");

				$(".tabbox").eq(index).addClass("active").siblings()
						.removeClass("active");
			});
	$("#step1").on(
			"click",
			function() {
				...
				$.ajax({
					...
					success : function(data) {
						console.log(data);
						if (data.result) {
							$("#tabul li").eq(1).find("span")
									.addClass("active");
							$("#tabul li").eq(1).siblings().removeClass(
									"active").find("span")
									.removeClass("active");
	...
	$("#step2").on(
			...
			function() {
				...
				$("#tabul li").eq(2).find("span").addClass("active");
				$("#tabul li").eq(2).siblings().removeClass("active").find(
						"span").removeClass("active");
				$(".tabbox").eq(2).addClass("active").siblings().removeClass(
						"active");
			});
	var sign = 0;
	$("#container").delegate("#step3", "click", function(event) {
		timer(1);
