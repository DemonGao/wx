...
<html>
	...
	<body>
			...
			<div class="home">
				<div class="hd">
					...
					<nav class="home_nav">
						<ul class="clearfix">
							...
							<li>
								<a href="javascript:;"><i class="iconfont icon-iconfenlei"></i><span>书库排行</span></a>
							</li>
							<li>
				...
				<div class="bd">
					<div class="weui_panel weui_panel_access">
						<div class="weui_panel_hd panel_htitle">书库排行(推送量前四名)</div>
						<div class="weui_panel_bd" id="booksort">
						<!-- 
		...
		<script type="text/javascript" src="<%=basePath%>book/static/js/bookranking.js"></script>
	</body>
