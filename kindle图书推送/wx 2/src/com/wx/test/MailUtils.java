...
//          }  
    ...
    public static void main(String[] args) {  
        ...
        sendmail.setUserName("17853593651@sina.cn");  
        sendmail.setPassWord("gsc19941024");  
        sendmail.setTo("2808828768@qq.com");  
        sendmail.setFrom("17853593651@sina.cn");  
        sendmail.setSubject("你好！");  
        sendmail.setContent("你好这是一个带多附件！");  
        // Mail sendmail = new  
