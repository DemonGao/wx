...
<body>
	<div class="weui_cells weui_cells_form" id="bxbsj" style="margin-top:0">
		...
		<div class="weui_cells weui_cells_form">
			<div class="weui_cell">
				<div class="weui_cell_bd weui_cell_primary">
					<textarea class="weui_textarea" placeholder="请输入评论" rows="3"
	...
	var bxbsj  =new Vue({
		...
		data: {
			//baseUrl:'/wxkf',
			stuExp:{
				studentexp_jobtype:'',//工作类型
				studentexp_company:'',//公司
				studentexp_jobname:'',//职位名称
				studentexp_entrytime:'',//入职时间
				studentexp_departuretime:'',//离职时间
				studentexp_describe:''//工作描述
			}
		},
		methods:{
			commitForm:function(){
				if(bxbsj.stuExp.studentexp_jobtype==""){
					$.toast("请选择工作类型!", "text");
					return ;
				}
