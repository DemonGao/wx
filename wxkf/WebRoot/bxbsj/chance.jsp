		...
		<script>
				...
				$.ajax({
					...
					success:function(data){
						if(!data.result){
							window.location.href="/wxkf/bxbsj/company_index.jsp?openid="+localStorage.getItem("openid");
						}else{
							window.location.href="/wxkf/bxbsj/index.jsp?openid="+localStorage.getItem("openid");
						}
					}
				})
		</script>
