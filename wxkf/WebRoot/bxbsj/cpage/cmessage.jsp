			...
			<div class="weui_tab_bd">
				<div class="box nospacebox nopadding nomargin">
					<div class="weui-row weui-no-gutter box plate nomargin">
						<!-- 
						<a href="joboffer.html" class="weui-col-33">
							<div>
						 ...
						 -->
						<a href="cjobfeedback.jsp" class="weui-col-50">
							<div>
								<i class="iconfont icon-contact color-blue"></i>
								<p class="color-default">投递情况</p>
							</div>
						</a>
						<a href="cresume_likejob.jsp" class="weui-col-50">
							<div>
