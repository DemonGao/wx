...
<body class="sticky-header">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="menu-list">
						...
						<ul class="sub-menu-list">
							...
							<li><a href="<%=basePath%>admin/pages/company_qualification.jsp">企业认证</a></li>
	...
	<!-- Ajax -->
	<script type="text/javascript" src="<%=basePath%>admin/statics/js/company_qualification.js"></script>
</body>
</html>
