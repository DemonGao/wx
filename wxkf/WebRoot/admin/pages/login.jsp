...
<body class="login-body">
	...
	<div class="container">
		...
		<form class="form-signin" action="<%=path%>/Admin/Admin_adminLogin">
			<div class="form-signin-heading text-center">
				<h1 class="sign-title">Sign In</h1>
				<img src="<%=basePath %>/admin/static/images/dtechlogo.jpg" alt="" />
			</div>
			<div class="login-wrap">
				<input name="admin.adminname" type="text" class="form-control" placeholder="User ID" autofocus />
				<input name="admin.password" type="password" class="form-control" placeholder="Password" />
