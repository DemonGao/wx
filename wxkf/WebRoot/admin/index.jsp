...
<!--icheck-->
<link
	href="<%=basePath%>/admin/static/js/iCheck/skins/minimal/minimal.css"
	rel="stylesheet">
<link
	href="<%=basePath%>/admin/static/js/iCheck/skins/square/square.css"
	rel="stylesheet">
<link href="<%=basePath%>/admin/static/js/iCheck/skins/square/red.css"
	rel="stylesheet">
<link href="<%=basePath%>/admin/static/js/iCheck/skins/square/blue.css"
	rel="stylesheet">

<!--dashboard calendar-->
<link href="<%=basePath%>/admin/static/css/clndr.css" rel="stylesheet">

<!--Morris Chart CSS -->
<link rel="stylesheet"
	href="<%=basePath%>/admin/static/js/morris-chart/morris.css">
...
<body class="sticky-header">
			...
			<div class="wrapper">
					...
					<div class="col-md-4">
						<div class="panel">
							<header class="panel-heading">
								goal progress <span class="tools pull-right"> <a
						...
						<div class="panel green-box">
							<div class="panel-body extra-pad">
								<div class="row">
									<div class="col-sm-6 col-xs-6">
										<div class="knob">
											<span class="chart" data-percent="79"> <span
												class="percent">79% <span class="sm">New Visit</span></span>
											</span>
										</div>
									</div>
									<div class="col-sm-6 col-xs-6">
										<div class="knob">
											<span class="chart" data-percent="56"> <span
												class="percent">56% <span class="sm">Bounce
														rate</span></span>
											</span>
										</div>
									</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="panel">
							<header class="panel-heading">
								Todo List <span class="tools pull-right"> <a
					...
					<div class="col-md-4">
						<div class="panel blue-box twt-info">
							<div class="panel-body">
								...
								<p>
									AdminEx is new model of admin dashboard <a href="#">http://t.co/3laCVziTw4</a>
	...
	<script
		src="<%=basePath%>/admin/static/js/jquery-ui-1.9.2.custom.min.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/jquery-migrate-1.2.1.min.js"></script>
	...
	<!--easy pie chart-->
	<script
		src="<%=basePath%>/admin/static/js/easypiechart/jquery.easypiechart.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/easypiechart/easypiechart-init.js"></script>

	<!--Sparkline Chart-->
	<script
		src="<%=basePath%>/admin/static/js/sparkline/jquery.sparkline.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/sparkline/sparkline-init.js"></script>

	<!--icheck -->
	<script src="<%=basePath%>/admin/static/js/iCheck/jquery.icheck.js"></script>
	<script src="<%=basePath%>/admin/static/js/icheck-init.js"></script>

	<!-- jQuery Flot Chart-->
	<script src="<%=basePath%>/admin/static/js/flot-chart/jquery.flot.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/flot-chart/jquery.flot.tooltip.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/flot-chart/jquery.flot.resize.js"></script>


	<!--Morris Chart   MONTHLY REVENUE REPORT 大折线走势图-->
	<script src="<%=basePath%>/admin/static/js/morris-chart/morris.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/morris-chart/raphael-min.js"></script>

	<!--Calendar 日历-->
	<script src="<%=basePath%>/admin/static/js/calendar/clndr.js"></script>
	<script
		src="<%=basePath%>/admin/static/js/calendar/evnt.calendar.init.js"></script>
	<script src="<%=basePath%>/admin/static/js/calendar/moment-2.2.1.js"></script>
	<script
	...
	<!--Dashboard Charts   图表数据-->
	<script src="<%=basePath%>admin/static/js/dashboard-chart-init.js"></script>
